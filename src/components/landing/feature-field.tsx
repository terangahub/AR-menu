...
// Une seule vitesse pour toutes les rangees, et 5x plus lente qu'a
// l'origine : le defilement etait juge trop rapide, et les vitesses
// alternees d'une rangee a l'autre (38s a 65s) donnaient un rendu
// desordonne. On garde la duree la plus lente d'avant (65s) multipliee
// par 5. Seul le sens reste alterne, pour eviter que le champ se lise
// comme un seul bloc qui glisse.
const ROW_DURATION_SECONDS = 325;
        ...
        {Array.from({ length: ROW_COUNT }).map((_, row) => {
          ...
          return (
            <div
              ...
              style={{
                // Sens alterné d'une rangée à l'autre : sans ça le champ
                // se lit comme un seul bloc qui glisse. La vitesse, elle,
                // est la même partout (cf. ROW_DURATION_SECONDS).
